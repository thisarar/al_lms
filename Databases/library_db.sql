...
/****** Object:  Database [library_db]    Script Date: 7/11/2017 9:55:22 PM ******/
CREATE DATABASE [library_db]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'library_db', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\library_db.mdf' , SIZE = 4160KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'library_db_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.SQLEXPRESS\MSSQL\DATA\library_db_log.ldf' , SIZE = 1040KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO

ALTER DATABASE [library_db] SET COMPATIBILITY_LEVEL = 110
GO
...
ALTER DATABASE [library_db] SET TARGET_RECOVERY_TIME = 0 SECONDS 
GO
